...
class CheckTest < Test::Unit::TestCase
  ...
  def test_invalid_routing_number
    ...
    assert !c.valid?
    assert_equal "is invalid", c.errors.on(:routing_number)
  end
  ...
  def test_account_holder_type
    ...
    c.valid?
    assert_equal 'must be personal or business', c.errors.on(:account_holder_type)
  ...
  def test_account_type
    ...
    c.account_type = 'moo'
    c.valid?
    assert_equal "must be checking or savings", c.errors.on(:account_type)
