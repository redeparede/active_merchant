...
class CreditCardTest < Test::Unit::TestCase
  ...
  def test_should_be_able_to_access_errors_indifferently
    ...
    assert_not_valid @visa
    assert_equal "cannot be empty", @visa.errors.on(:first_name)
    assert_equal "cannot be empty", @visa.errors.on("first_name")
  end
  ...
  def test_should_be_able_to_identify_invalid_card_numbers
    ...
    assert_equal "is invalid", @visa.errors.on(:number)
  ...
  def test_should_have_errors_with_invalid_card_type_for_otherwise_correct_number
    ...
    assert_equal "invalid for type", @visa.errors.on(:number)
  end
  ...
  def test_should_be_invalid_when_type_cannot_be_detected
    ...
    assert_not_valid @visa
    assert_equal "is required",  @visa.errors.on(:type)
  end
  ...
  def test_should_not_be_valid_with_empty_month
    ...
    assert_not_valid @visa
    assert_equal "is invalid", @visa.errors.on('month')
  end
  ...
  def test_should_be_invalid_with_empty_year
    @visa.year = ''
    assert_not_valid @visa
    assert_equal "expired", @visa.errors.on('year')
  end
  ...
  def test_should_not_be_valid_for_edge_year_cases
    ...
    assert_not_valid @visa
    assert_equal "is invalid", @visa.errors.on('year')
  end
  ...
  def test_should_require_valid_start_date_for_solo_or_switch
    ...
    assert_equal "is invalid", @solo.errors.on('start_month')
    assert_equal "is invalid", @solo.errors.on('start_year')
    assert_equal "cannot be blank", @solo.errors.on('issue_number')
